        ...
        <div class="col-md-4 col-sm-6">
          <div class="blog-post">
            ...
            <div class="down-content">
              <a href="offers.html"><h4><?= $mb->merk; ?></h4></a>
              ...
              <div class="row">
                ...
                <?php if($mb->supir == '1'){ ?>
                  <a href="#" class="badge badge-success m-1"><i class="fa fa-check-square"></i> Supir</a>
                  <?php } 
                else{ ?>
                  <a href="#" class="badge badge-danger m-1"><i class="fa fa-times-circle"></i> Supir</a>
                <?php } ?>
